    ...
    <div>
        <el-form :model="accountForm" :rules="rules" ref="accountForm" label-width="100px" class="demo-ruleForm">
            <el-form-item label="帐号" prop="name" style="width: 300px;">
                <el-input size="mini" v-model="accountForm.name" placeholder="请输入帐号" maxlength="12" :disabled="accountForm['disabled']"></el-input>
            </el-form-item>
            <el-form-item label="密码" prop="password" style="width: 300px;" v-if="accountForm['dShow']">
                <el-input size="mini" v-model="accountForm.password" placeholder="请输入密码" minlength="6" maxlength="12" :type="inputType">
            ...
            <el-form-item label="角色" prop="role" style="width: 300px;" v-if="accountForm['mShow']">
                <el-select v-model="accountForm.role" :placeholder="$t('message.common.choose')" :disabled="accountForm['mDisabled']">
