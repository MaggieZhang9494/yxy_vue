...
<template>
    <div style="height:100%">
        <content-head :headTitle="'message.menuName.unusualContract'" :headTitlePath="{path:'/unusualContract'}" @changGroup="changGroup"></content-head>
        <div class="module-wrapper">
            <div class="search-part">
                ...
                <div class="search-part-right">
                    <el-input size="mini" :placeholder="$t('message.contractIDE.inputContractAddress')" v-model="contractAddress" class="input-with-select" @clear="clearText">
            ...
            <div class="search-table">
                <el-table :data="hashData" tooltip-effect="light" style="overflow-y: auto; height:100%" v-loading="loading">
                    ...
                    <el-table-column v-for="head in unusualContractHead" :key="head.enName" :label="head.name" show-overflow-tooltip align="left" v-if="head.enName!=='hashs'">
            ...
            <div class="notify-cation" v-if="noticeVisibility">
                ...
                <p>{{$t('message.uusualUser.tips1')}}</p>
            </div>
        </div>
    </div>
</template>
        ...
        getUnusualContractList() {
            ...
            unusualContractList(reqData, reqQuery)
                ...
                .catch(err => {
                    this.loading = false;
                    this.$message({
                        message: this.errcode.errCode.isCN?this.errcode.errCode[err.data.code].cn:this.errcode.errCode[err.data.code].en || this.$i18n.t('message.uusualUser.seachConFail'),
                        type: "error",
                        duration: 2000
                    });
                });
