<template>
    <div>
        <v-content-head 
            :headTitle="'message.menuName.systemManagement'" 
            :headSubTitle="'权限管理'" 
        ...
        <div class="module-wrapper" style="padding: 30px 29px 0 29px;">
            <el-form :model="permissionForm" :rules="rules" ref="permissionForm" class="demo-ruleForm">
                <!-- <el-form-item :label="$t('message.nodeManagement.administratorAcc')" prop="adminRivateKeyAddress" class="item-form">
                    <el-select v-model="permissionForm.adminRivateKeyAddress" :placeholder="$t('message.common.choose')" class="select-32">
                ...
                <el-form-item label="权限类型" prop="authorType" class="item-form">
                    <el-select v-model="permissionForm.authorType" :placeholder="$t('message.common.choose')" class="select-32" @change="selectAuthorType">
                ...
                <el-form-item label="表名" prop="tableName" class="item-form" v-if="permissionForm.authorType==='userTable'">
                    <el-input size="mini" v-model.trim="permissionForm.tableName" class="select-32" v-if="permissionForm.authorType==='userTable'"></el-input>
                </el-form-item>
                <!-- <el-form-item label="外部帐号地址" prop="otherRivateKey" class="item-form">
                ...
                <el-form-item>
                    ...
                    <el-tooltip effect="dark" content="Tips: 添加第一个管理员权限的时候，管理员将启动权限，请确认帐号是否正确。误操作可能导致服务不可用。" placement="top-start">
...
export default {
    ...
    methods: {
        ...
        addAuthor() {
            this.$confirm("添加第一个管理员权限的时候，管理员将启动权限，请确认帐号是否正确。误操作可能导致服务不可用。", 'Tips', {
                center: true,
