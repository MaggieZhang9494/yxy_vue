    ...
    <div>
        <el-form :model="permissionForm" :rules="rules" ref="permissionForm" label-width="110px" class="demo-ruleForm">
            ...
            <!-- <el-form-item label="权限类型" prop="authorType" class="item-form" style="width: 320px;">
                <el-select v-model="permissionForm.authorType" :placeholder="$t('message.common.choose')" :disabled="btnType==='deleteBtn'? true: false">
            ...
            <el-form-item label="表名" prop="tableName" class="item-form" v-if="permissionForm.authorType==='userTable'" style="width: 320px;">
                <el-input size="mini" v-model.trim="permissionForm.tableName" v-if="permissionForm.authorType==='userTable'"></el-input>
            </el-form-item>
            <el-form-item label="外部帐号地址" prop="otherRivateKey" style="width: 320px;" v-if="btnType==='addBtn'">
            ...
            <el-form-item label="外部帐号地址" style="width: 320px;" v-if="btnType==='deleteBtn'">
