        ...
        <div class="module-wrapper">
            <div class="search-part text-left search-min-width">
                <div class="search-part-label">
                    ...
                    <el-select v-model="nodeId" :placeholder="$t('message.common.choose')" @change="changeNodeId" class="select-32" style="width:189px;">
                ...
                <div class="search-part-label">
                    <span class="search-part-label-title">{{$t('message.common.chooseDate')}}:</span>
                    <el-date-picker @change="changeDate" v-model="errorLogDate" type="datetimerange" :picker-options="errorLogPickerOptions" :range-separator="$t('message.common.to')" start-placeholder="开始日期" end-placeholder="结束日期" align="left" value-format="yyyy-MM-dd HH:mm:ss" class="date-select-32">
                    </el-date-picker>
                </div>
                <div class="search-part-label1">
                    <el-button type="primary" @click="sureSelct" class="button-32 search-part-label-title1">{{$t('message.common.confirm')}}</el-button>
                </div>
            </div>
        ...
        getNodeData(callback) {
            ...
            getErrorNodeList(reqString)
                ...
                .catch(err => {
                    ...
                    this.$message({
                        message:
                            this.errcode.errCode.isCN?this.errcode.errCode[err.data.code].cn:this.errcode.errCode[err.data.code].en || "查询节点失败！",
                        type: "error",
                        duration: 2000
                    });
                });
