...
<template>
    <div>
        <v-content-head :headTitle="title" :headTitlePath="{path:'/topImportOrigin'}"></v-content-head>
        <div class="module-wrapper">
            <el-menu :default-active="activeIndex" class="el-menu-statistics" mode="horizontal" @select="handleSelect" text-color="#000" active-text-color="#1585FF">
                <el-menu-item index="1">{{$t('message.statistics.top10ImportOrigin')}}</el-menu-item>
            </el-menu>
