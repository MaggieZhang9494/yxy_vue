<template>
    <div>
        <v-content-head :headTitle="title" :headTitlePath="{path:'/customsVolume'}"></v-content-head>
        <div class="module-wrapper">
            <el-menu :default-active="activeIndex" class="el-menu-statistics" mode="horizontal" @select="handleSelect" text-color="#000" active-text-color="#1585FF">
                <el-menu-item index="1">{{$t('message.statistics.customsDeclarationVolume')}}</el-menu-item>
            </el-menu>
                ...
                <div style="border:solid 1px #f1f1f1;height:100%;margin:20px;">
                    ...
                    <div class="transOrderChart-content" v-loading="loading">
                        <div class="chartBgClass">
                            <v-line-chart :defaultPeriod="defaultPeriod" :changePeriod="changePeriod" :chartOption="orderStatistics"> </v-line-chart>
                        </div>
                    </div>
                </div>
