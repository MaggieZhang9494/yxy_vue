<template>
    <div>
        <v-content-head :headTitle="title" :headTitlePath="{path:'/topAccOceanOrder'}"></v-content-head>
        <div class="module-wrapper">
            <el-menu :default-active="activeIndex" class="el-menu-statistics" mode="horizontal" @select="handleSelect" text-color="#000" active-text-color="#1585FF">
                <el-menu-item index="1">{{$t('message.statistics.top10OceanAcc')}}</el-menu-item>
            </el-menu>
    ...
    data() {
        return {
            ...
            searchParams:{
                ...
                TRADE_TOOL_TYPE_NAME:"水路运输",//运输方式，可为空
    ...
    methods: {
        ...
        loadSummaryModeList(){
            ...
            getSummaryModeList(reqData).then(res => {
                // this.loading = false;
                if (res.data.code === 0) {
                    _this.summaryWayList = res.data.data;
