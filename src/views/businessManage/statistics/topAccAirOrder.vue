<template>
    <div>
        <v-content-head :headTitle="title" :headTitlePath="{path:'/topAccAirOrder'}"></v-content-head>
        <div class="module-wrapper">
            <el-menu :default-active="activeIndex" class="el-menu-statistics" mode="horizontal" @select="handleSelect" text-color="#000" active-text-color="#1585FF">
                <el-menu-item index="1">{{$t('message.statistics.top10AirAcc')}}</el-menu-item>
            </el-menu>
    ...
    data() {
        return {
            ...
            searchParams:{
                ...
                TRADE_TOOL_TYPE_NAME:"航空运输",//运输方式，可为空
                /*
                  D/W/M/Q/Y为单选项可选。
                  D: 每日daily （当日0点-24点）；
