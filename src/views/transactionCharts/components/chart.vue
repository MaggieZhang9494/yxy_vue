...
<template>
    <div style="padding-left: 30px;">
        <div class="charts-title text-left">
            <span class="total-count">{{$t('message.userTransaction.totalNum')}}：{{numberFormat(chartStatistics.totalCount, 0, ".", ",")}}</span>
        </div>
    ...
    methods: {
        chartShow: function() {
            ...
            let option = {
                ...
                noDataLoadingOption: {
                    text: this.$i18n.t('message.common.noData'),
                    effect: "bubble",
                    effectOption: {
                        effect: {
                            n: 0
                ...
                tooltip: {
                    ...
                    formatter: function(data) {
                        return (
                            ...
                            '<span style="font-size:10px;color:white">'+i18n.t('message.userTransaction.businessVol')+'：' +
                            data[0].value +
                            i18n.t('message.userTransaction.several')+"</a></span><br></td></tr></table>"
                        );
                    }
                },
                grid: {
