            ...
            <div>
                <el-form :model="nodeForm" :rules="rules" ref="nodeForm" label-width="100px" class="demo-ruleForm">
                    <el-form-item label="节点名称" prop="name" style="width: 300px">
                        <el-input size="mini" v-model="nodeForm.name" maxlength="12"></el-input>
                    </el-form-item>
                    <el-form-item label="节点IP" prop="ip" style="width: 300px">
                        <el-input size="mini" v-model="nodeForm.ip"></el-input>
                    </el-form-item>
                    <el-form-item label="p2p端口" prop="p2pPort" style="width: 300px">
                        <el-input size="mini" v-model="nodeForm.p2pPort"></el-input>
                    </el-form-item>
                    <el-form-item label="rpc端口" prop="rpcPort" style="width: 300px">
                        <el-input size="mini" v-model="nodeForm.rpcPort"></el-input>
                    </el-form-item>
                </el-form>
            </div>
            <div slot="footer" class="dialog-footer">
                <el-button @click="modelClose">{{$t('message.common.cancel')}}</el-button>
                <el-button type="primary" @click="submit('nodeForm')">{{$t('message.common.confirm')}}</el-button>
            </div>
        </el-dialog>
    </div>
</template>
