            ...
            <div>
                <el-form :model="groupForm" :rules="rules" ref="groupForm" label-width="100px" class="demo-ruleForm">
                    <el-form-item label="组织名称" prop="name" style="width: 300px;">
                        <el-input size="mini" v-model="groupForm.name" placeholder="请输入组织名称" maxlength="12"></el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="备注" style="width: 300px">
                        <el-input size="mini" type="textarea" v-model="groupForm.explain" placeholder="请输入备注"></el-input>
                    </el-form-item>
                </el-form>
            </div>
            <div slot="footer" class="dialog-footer">
                <el-button @click="modelClose">{{$t('message.common.cancel')}}</el-button>
                <el-button type="primary" @click="submit('groupForm')">{{$t('message.common.confirm')}}</el-button>
            </div>
        </el-dialog>
    </div>
</template>
