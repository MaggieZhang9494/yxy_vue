...
<template>
    <div class="bg-f7f7f7">
        <!-- <v-content-head :headTitle="'message.menuName.contractManagement')" :icon="true" v-if="urlQuery.from==='home'" :route="`${urlQuery.from}`"></v-content-head> -->
        <v-content-head  :headTitle="'message.menuName.contractManagement'" :headTitlePath="{path:'/contract'}" style="font-size: 14px;"  @changGroup="changGroup"></v-content-head>
