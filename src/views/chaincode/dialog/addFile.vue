...
<template>
    <div>
        <el-dialog :title="$t('message.contractIDE.addFile')" :visible.sync="dialogVisible" :before-close="modelClose" class="dialog-wrapper" width="433px" :center="true">
            <div>
                <el-form :model="fileFrom" :rules="rules" ref="fileFrom" :label-width="labelWidth" class="demo-ruleForm">
                    <el-form-item :label="$t('message.contractIDE.contractName')" prop="contractName" >
                        <el-input size="mini" v-model="fileFrom.contractName" style="width: 173px;"></el-input>
                    </el-form-item>
                    <el-form-item :label="$t('message.contractIDE.fileCatalog')" >
                        <el-select size="mini" v-model="fileFrom.contractType" :disabled='disabled' :placeholder="$t('message.common.choose')">
                            <el-option
            ...
            <div slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" @click="submit('fileFrom')">{{$t('message.common.confirm')}}</el-button>
            </div>
        </el-dialog>
    </div>
</template>
