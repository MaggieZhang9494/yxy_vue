    ...
    <div>
        <el-dialog title="新建合约" :visible.sync="dialogVisible" :before-close="modelClose" class="dialog-wrapper" width="433px" :append-to-body="true" :center="true">
            <el-form :model="chaincodeForm" :rules="rules" ref="chainForm" label-width="100px" class="demo-ruleForm">
                <el-form-item :label="$t('message.contractIDE.contractName')" prop="name" style="width:330px">
                    <el-input size="mini" v-model="chaincodeForm.name" maxlength="32" :placeholder="$t('message.contractIDE.inputConName')"></el-input>
                ...
                <el-form-item :label="$t('message.cnsInquire.contractVersion')" prop="version" style="width:330px">
                    <el-input size="mini" v-model="chaincodeForm.version" maxlength="12" placeholder="请输入版本号"></el-input>
                    <el-tooltip effect="dark" placement="right">
                        <div slot="content">
            ...
            <div slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" @click="submit('chainForm')">{{$t('message.common.confirm')}}</el-button>
            </div>
        </el-dialog>
    </div>
</template>
