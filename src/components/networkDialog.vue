...
<template>
    <div class="network-wrapper">
        <span>选择区块链</span>
        <el-select v-model="value" :placeholder="$t('message.common.choose')" @change="change($event)" class="block-network" filterable clearable>
        ...
        <el-input size="mini" v-model="contractId" class="block-name-input" size="mini" disabled></el-input>
        <div class="network-footer">
            <el-button @click="close" class="network-footer-close">{{$t('message.common.cancel')}}</el-button>
            <el-button type="primary" @click="submit" class="network-footer-sure">{{$t('message.common.confirm')}}</el-button>
        </div>
    </div>
</template>
