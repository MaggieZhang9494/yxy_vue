 ...
 */
let errCode = {
    isCN:window.localStorage.getItem("internationalization") == 'zh-cn',
    "101001": {
        en: "system error",
        cn: '系统异常'
    },
    ...
    "202064": {
        en: "login fail, user has been disabled.",
        cn: "登录失败，用户已被禁用。"
    },
    "202065": {
        en: "export template not found.",
        cn: "未找到导出模板。"
    },
    "202066": {
    ...
    "202067": {
        en: "export status is abnormal.",
        cn: "导出状态异常。"
    },
    "202068": {
        en: "account address info not exists",
        cn: "该账号地址信息不存在。"
	},
	"202080":{
		en: "ERP user info get failed",
        cn: "企业微信用户信息获取失败。"
	},
    "302000": {
        en: "No login, Please Login!",
        cn: '未登录，请先登录！'
    },
    "302001":{
        en: "access denied",
